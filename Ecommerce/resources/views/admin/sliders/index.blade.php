                    ...
                    <tbody>
                       @foreach ($sliders as $slider)
                           <tr>
                                ...
                                <td>
                                    <a href="{{asset('admin/sliders/'.$slider->id.'/edit')}}" class="btn btn-success btn-sm">Edit</a>
                                    <a href="{{asset('admin/sliders/'.$slider->id.'/delete')}}" class="btn btn-danger  btn-sm">Delete</a>
                                </td>
                           </tr>
                       @endforeach
                    </tbody>
